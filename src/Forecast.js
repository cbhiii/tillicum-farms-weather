      ...
      <div className="Forecast">
        ...
        <Row className="forecast-text">
          <Col xs={4}>
            ...
            }{this.props.ftemp0}<span className="wi wi-degrees"></span><br /><span className={`wi wi-wind wi-from-${ this.props.fwindd0}`}></span> {this.props.fwind0}</span>
          </Col>
          <Col xs={4}>
            ...
            }{this.props.ftemp1}<span className="wi wi-degrees"></span><br /><span className={`wi wi-wind wi-from-${ this.props.fwindd1}`}></span> {this.props.fwind1}</span>
          </Col>
          <Col xs={4}>
            ...
            }{this.props.ftemp2}<span className="wi wi-degrees"></span><br /><span className={`wi wi-wind wi-from-${ this.props.fwindd2}`}></span> {this.props.fwind2}</span>
          </Col>
        </Row>
      </div>
